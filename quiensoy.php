  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link text-center" href="#">¿Quién soy? <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-center" href="#">¿Qué hago?</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-center" href="#">¡Contáctame!</a>
      </li>
    </ul>
  </div>
</nav>
